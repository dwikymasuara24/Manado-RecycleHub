...
try {
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS `cleanup_requests` (
          ...
          `area_size_sqm` decimal(10,2) DEFAULT NULL COMMENT 'Estimasi luas area (m2)',
          `dominant_waste` varchar(255) DEFAULT NULL COMMENT 'Jenis sampah dominan',
    ...
    // 2. Table cleanup_items (for PET/plastic bottles sorting weights)
    $pdo->exec("

-- Fix missing columns in pickup_requests
ALTER TABLE `pickup_requests` 
ADD COLUMN `latitude` DECIMAL(10, 8) NULL AFTER `kelurahan`,
...
-- Create schedule_requests table (as used in rute_jadwal.php reset logic)
